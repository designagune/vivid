	...
	<body>
		<div class="wrap"><!--추후 height수정-->
			...
			<div class="content">
				...
				<!--contents-->
				<section id="sec2">
					<div id="contPlus" class="insize row">
						<div class="grid12">
							<div class="row">
								<div class="grid7">
									<div class="cont_text">
									...
									<div class="cont_image">
										<div class="swiper-container gallery-top">
										    <div class="swiper-wrapper">
											    <a href="http://www.hypnotic.co.kr" target="_blank" class="swiper-slide hp"></a>
											    <a href="http://www.66girls.co.kr" target="_blank" class="swiper-slide six"></a>
											    <a href="https://www.attrangs.co.kr/" target="_blank" class="swiper-slide at"></a>
											    <a href="http://www.secretlabel.co.kr/" target="_blank" class="swiper-slide sc"></a>
											    <a href="https://www.merongshop.com/" target="_blank" class="swiper-slide mr"></a>
											    <a href="https://shehj.com/" target="_blank" class="swiper-slide hj"></a>
											    <a href="https://www.blla.co.kr/" target="_blank" class="swiper-slide bl"></a>
											    <a href="http://www.dabagirl.co.kr/" target="_blank" class="swiper-slide db"></a>
											    <a href="http://www.bullang.com" target="_blank" class="swiper-slide bu"></a>
											    <a href="https://icecream12.com/" target="_blank" class="swiper-slide ic"></a>
										    </div>
									    	<!-- Add Arrows -->
								...
								<div class="grid4">
									...
									<div class="cont_image">
										<div class="genderlist">
											<div class="genwoman active">woman</div>
											<div class="genman">man</div>
											<div class="genunisex">unisex</div>
											<ul>
												<li>
													<ul class="inlist">
									...
									<div class="cont_image">
									    ...
									    <div class="blacktext">
									    	...
									    	<p>배우 한예슬의 올 블랙 패션은 화려한 컬러 앞에서 굴복하기는커녕 오히려 더욱 큰 아우라를 내뿜는다.
									    		<br/>
									    		차분하고 시크한 올 블랙을 컬러를 선택했지만 실루엣과 소재는 평범하지 않은 것. 허리 라인을 강조한 시스루 재킷과 무늬가 새겨진 블랙 스타킹을 매치해 자칫 심심할 수 있는 올 블랙 룩에 포인트를 줬다. 
									    	</p>
									    	<a href="http://www.thesingle.co.kr/SinglesMobile/mobileweb/news_content/detail_news_content.do?nc_no=708770&fmc_no=599684&fsmc_no=599709&fsmc_nm=star" target="_blank">+더보기</a>
									    </div>
									    <script>
					...
					<div id="cont3" class="insize row">
						<div class="grid12">
							...
							<div class="grid4">
								...
								<div class="cont_image">
									<a href="https://accounts.kakao.com/login?continue=http%3A%2F%2Fpf.kakao.com%2F_xexjPYj%2Fchat" target="_blank">
